...
namespace DataSource
{
	...
	{
		public static MiscUtil.Conversion.EndianBitConverter bBitConverter = new MiscUtil.Conversion.BigEndianBitConverter();
		...
		{
			return GetBytes(bBitConverter.SingleToInt32Bits(data));
		}

		public static byte[] GetBytes(double data)
		{
			return GetBytes(bBitConverter.DoubleToInt64Bits(data));
		}
		...
		{
			return bBitConverter.ToSingle(data, startIndex);
			//if (data == null || data.Length - startIndex < 4)
			//    return 0;
			//// ---------- simple:
			//return bBitConverter.Int32BitsToSingle(ToInt32(data, startIndex));
		}

		public static double ToDouble(byte[] data, int startIndex)
		{
			return bBitConverter.ToDouble(data, startIndex);
			//if (data == null || data.Length - startIndex < 8)
			//    return 0;
			//// ---------- simple:
			//return bBitConverter.Int64BitsToDouble(ToInt64(data, startIndex));
		}
